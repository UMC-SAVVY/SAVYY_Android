...
import com.example.savvy_android.fragment.DiaryFragment
import com.example.savvy_android.fragment.HomeFragment
import com.example.savvy_android.fragment.MypageFragment
import com.example.savvy_android.fragment.TravelPlanFragment
    ...
    private fun setBottomNavi() {
        ...
        binding.mainBottomNavi.setOnItemSelectedListener { item ->
            when (item.itemId) {
                ...
                R.id.plan -> {
                    setFragment(TravelPlanFragment())
                    return@setOnItemSelectedListener true
                }
                R.id.diary -> {
