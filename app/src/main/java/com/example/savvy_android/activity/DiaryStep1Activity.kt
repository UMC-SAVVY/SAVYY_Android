...
import com.example.savvy_android.adapter.DiaryPlanListAdapter
import com.example.savvy_android.databinding.ActivityDiaryStep1Binding
import com.example.savvy_android.dialog.DiaryStopDialogFragment
import com.example.savvy_android.dialog.NextStepDialogFragment
import com.example.savvy_android.dialog.PlanSelectDialogFragment

class DiaryStep1Activity : AppCompatActivity() {
    private lateinit var binding: ActivityDiaryStep1Binding
    private lateinit var diaryPlanListAdapter: DiaryPlanListAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        diaryPlanListAdapter = DiaryPlanListAdapter(mutableListOf("", "", "", "", ""))
