...
//            startActivity(intent)
        ...
        binding.travelPlanSearchEdit.addTextChangedListener(object : TextWatcher {
            override fun beforeTextChanged(s: CharSequence?, start: Int, count: Int, after: Int) {}

            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                val isEnableState = binding.travelPlanSearchEdit.length() != 0
                binding.travelPlanSearchBtn.isEnabled = isEnableState
                btnStateBackground(isEnableState, binding.travelPlanSearchBtn)
            }
    ...
    override fun onResume() {
        ...
        // 검색 기능
        binding.travelPlanSearchBtn.setOnClickListener {
            Log.e("TEST", "검색 버튼 눌림")
            searchPlanList(binding.travelPlanSearchEdit.text.toString())
        }
