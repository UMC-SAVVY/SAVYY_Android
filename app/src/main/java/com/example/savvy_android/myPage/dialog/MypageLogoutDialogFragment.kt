...
import com.example.savvy_android.databinding.DialogMypageLogoutBinding
import com.example.savvy_android.init.LoginActivity
...
class MypageLogoutDialogFragment : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // 탈퇴 버튼 클릭 시
        binding.dialogLogoutBtnO.setOnClickListener {
            // buttonClickListener.onDialogPlanBtnOClicked()
            dismiss()

            // 초기 화면으로 이동
            val intent = Intent(requireContext(), LoginActivity::class.java)
            // 이전에 존재하던 모든 activity 종료
        ...
        // 취소하기 버튼 클릭 시
        binding.dialogLogoutBtnX.setOnClickListener {
