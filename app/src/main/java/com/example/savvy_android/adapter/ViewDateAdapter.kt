...
class ViewDateAdapter(private val items: MutableList<String>) :
    RecyclerView.Adapter<ViewDateAdapter.ViewDateViewHolder>() {
    private val placeMap: MutableMap<Int, ViewPlaceAdapter> = mutableMapOf()
    private var expandedPosition = 0 // 첫 번째 아이템의 인덱스


    inner class ViewDateViewHolder(private val binding: ItemViewDateBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewDateViewHolder {
        ...
        val binding = ItemViewDateBinding.inflate(inflater, parent, false)
